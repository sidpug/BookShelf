package com.sidpug.bookshelf.login.biometriclogin
...
import com.sidpug.bookshelf.databinding.ActivityEnableBiometricLoginBinding
import com.sidpug.bookshelf.login.BookShelfAppUser
import com.sidpug.bookshelf.login.FailedLoginFormState
import com.sidpug.bookshelf.login.LoginViewModel
import com.sidpug.bookshelf.login.SuccessfulLoginFormState
...
class EnableBiometricLoginActivity : AppCompatActivity() {
    ...
    private fun encryptAndStoreServerToken(authResult: BiometricPrompt.AuthenticationResult) {
        authResult.cryptoObject?.cipher?.apply {
            BookShelfAppUser.fakeToken?.let { token ->
